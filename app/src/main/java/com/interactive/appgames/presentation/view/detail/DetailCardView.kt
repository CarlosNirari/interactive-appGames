        ...
        ConstraintLayout {
            ...
            Box(
                ...
                Row(
                    ...
                    Text(
                        text = if (isPreview) "MMORPG" else gameEntity.genre,
                        color = Color(android.graphics.Color.parseColor("#9881f4")),
                        style = TextStyle(
            ...
            val painterThumbnail = if (isPreview) {
                ...
                rememberImagePainter(gameEntity.thumbnail)
            }
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = if (isPreview) "2003-06-01" else gameEntity.release_date,
                        fontSize = 9.sp,
                    ...
                    Text(
                        text = if (isPreview) "Anarchy Online" else gameEntity.title,
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Bold,
                    ...
                    Text(
                        text = if (isPreview) "A free to play Sci-Fi MMO that has withstood the test of time." else gameEntity.short_description,
                        fontSize = 14.sp,
