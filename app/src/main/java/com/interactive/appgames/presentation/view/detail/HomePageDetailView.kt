package com.interactive.appgames.presentation.view.detail
    ...
    Column(
        ...
        ConstraintLayout {
            ...
            val painterThumbnail = if (isPreview) {
                ...
                rememberImagePainter(mainViewModel.game.thumbnail)
            }
            Image(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = if (isPreview) "A free to play Sci-Fi MMO that has withstood the test of time." else mainViewModel.game.short_description,
                        fontSize = 20.sp,
                    ...
                    Text(
                        text = if (isPreview) "Funcom" else mainViewModel.game.publisher,
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Normal,
                        maxLines = 1,
                        color = Color(android.graphics.Color.parseColor("#5e3bee"))
                    ...
                    Text(
                        text = if (isPreview) "https://www.freetogame.com/anarchy-online" else mainViewModel.game.freetogame_profile_url,
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Normal,
                        color = Color(android.graphics.Color.parseColor("#5e3bee")),
                        modifier = Modifier
                            .clickable {
                                val intent = Intent(
                                    Intent.ACTION_VIEW,
                                    Uri.parse(if (isPreview) "https://www.freetogame.com/anarchy-online" else mainViewModel.game.freetogame_profile_url)
                                )
                    ...
                    Text(
                        text = if (isPreview) "https://www.freetogame.com/open/anarchy-online" else mainViewModel.game.game_url,
                        fontSize = 18.sp,
                        fontWeight = FontWeight.Normal,
                        color = Color(android.graphics.Color.parseColor("#5e3bee")),
                        modifier = Modifier
                            .clickable {
                                val intent = Intent(
                                    Intent.ACTION_VIEW,
                                    Uri.parse(if (isPreview) "https://www.freetogame.com/open/anarchy-online" else mainViewModel.game.game_url)
                                )
                                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                                CONTEXT?.startActivity(intent)
                            }
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = if (isPreview) "MMORPG" else mainViewModel.game.genre,
                                fontSize = 12.sp,
                                maxLines = 1,
                                fontWeight = FontWeight.Bold,
                                fontStyle = FontStyle.Italic,
                        ...
                        Column(
                            ...
                            Text(
                                text = if (isPreview) "2001-06-27" else mainViewModel.game.release_date,
                                fontSize = 12.sp,
                                maxLines = 1,
                                fontWeight = FontWeight.Bold,
                                fontStyle = FontStyle.Italic,
                        ...
                        Column(
                            ...
                            Text(
                                text = if (isPreview) "Funcom" else mainViewModel.game.developer,
                                fontSize = 12.sp,
                                maxLines = 1,
                                fontWeight = FontWeight.Bold,
                                fontStyle = FontStyle.Italic,
                        ...
                        Column(
                            ...
                            Text(
                                text = if (isPreview) "PC (Windows)" else mainViewModel.game.platform,
                                fontSize = 12.sp,
                                maxLines = 1,
                                fontWeight = FontWeight.Bold,
                                fontStyle = FontStyle.Italic,
